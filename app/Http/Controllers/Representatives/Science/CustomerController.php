...
class CustomerController extends Controller
{
    ...
    public function storeCustomer(Request $request)
    {
        ...
        return redirect('/repScience/manageCustomers')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function updateCustomer(Request $request,$id)
    {
        ...
        return redirect('/repScience/manageCustomers')->with('status','تم تعديل البيانات بشكل ناجح');
    }
