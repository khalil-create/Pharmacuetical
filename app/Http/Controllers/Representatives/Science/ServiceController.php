...
class ServiceController extends Controller
{
    ...
    public function storeService(Request $request)
    {
        ...
        return redirect('/repScience/manageServices')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function updateService(Request $request,$id)
    {
        ...
        return redirect('/repScience/manageServices')->with('status','تم تعديل البيانات بشكل ناجح');
    }
