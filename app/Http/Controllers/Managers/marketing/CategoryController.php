...
class CategoryController extends Controller
{
    ...
    public function storeCategory(Request $request)
    {
        ...
        return redirect('/manageCategory')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function UpdateCategory(Request $request,$id)
    {
        ...
        return redirect('/manageCategory')->with('status','تم تعديل البيانات بشكل ناجح');
    }
    public function deleteCategory($id)
    {
        ...
        return redirect('/manageCategory')->with('status','تم حذف البيانات بشكل ناجح');
    }
}
