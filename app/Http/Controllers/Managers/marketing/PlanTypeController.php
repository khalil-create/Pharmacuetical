...
class PlanTypeController extends Controller
{
    ...
    public function getAllPlanTypes(Request $request)
    {
        ...
        return view('managers.marketing.managePlanTypes',compact('planTypes'));
    }

    ///////////////////////////////////////////////////////////////////////////////////////////////
    public function addPlanType()
    {
        return view('managers.marketing.addPlanType');
    }
    ...
    public function storePlanType(Request $request)
    {
        ...
        return redirect('/managerMarketing/managePlanTypes')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function editPlanType($id)
    {
        ...
        return view('managers.marketing.editPlanType', compact('planType'));
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    public function UpdatePlanType(Request $request,$id)
    {
        ...
        $planType->update();
        return redirect('/managerMarketing/managePlanTypes')->with('status','تم تعديل البيانات بشكل ناجح');
    }
    public function deletePlanType($id)
    {
        ...
        // return redirect('/managerMarketing/managePlanTypes')->with('status','تم حذف البيانات بشكل ناجح');
    }
}
