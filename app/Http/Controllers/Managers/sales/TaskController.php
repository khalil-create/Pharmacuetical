...
class TaskController extends Controller
{
    ...
    //     return redirect('/managerSalesmanageChargedTasks')->with('status','تم اضافة تقرير انجاز المهمة بشكل ناجح');
    // }
    ...
    public function storeTask(Request $request)
    {
        ...
        return redirect('/managerSales/manageTasks')->with('status','تم إضافة المهمة بشكل ناجح');
    }
    ...
    public function updateTask(Request $request,$id)
    {
        ...
        return redirect('/managerSales/manageTasks')->with('status','تم تعديل المهمة بشكل ناجح');
    }
    public function deleteTask($id)
    {
        ...
        // return redirect('/managerSales/manageDistributedTasks')->with('status','تم حذف المهمة بشكل ناجح');
    }
}
