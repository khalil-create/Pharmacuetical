...
class UserController extends Controller
{
    ...
    public function adduser()
    {
        ...
        return view('admin.addUser',compact('supervisors'))->with('manager',$manager);
    }
    public function storeUser(Request $request)
    {
        ...
        else if($usertype == 'مدير فريق' || $usertype == 'مندوب علمي')
        {
            $sup = Supervisor::get();
        ...
        // dd($request->all());
        // $rules = $this->getRules();
        // $rules =['userimage' => 'required','email' => 'required|string|email|max:255|unique:users','phone_number' => 'required|numeric|unique:users',];
