...
class DoctorController extends Controller
{
    ...
    public function getAllDoctors(Request $request)
    {
        ...
        $doctors = Doctor::all();
        return view('admin.manageDoctors',compact('doctors'));
    }
    public function addDoctor()
    {
        ...
        return view('admin.addDoctor')->with('reps',$reps)->with('specialists',$specialists);
    }
    public function storeDoctor(Request $request)
    {
        ...
        return redirect('/admin/manageDoctors')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function editDoctor($id)
    {
        ...
        $reps = Representative::whereNotNull('supervisor_id')->get();
        $specialists = Specialist::all();
        return view('admin.editDoctor', compact('doctor'))->with('reps',$reps)->with('specialists',$specialists);
    }
    public function updateDoctor(Request $request,$id)
    {
        ...
        $doctor->update();
        $doctor->specialists()->attach($request->specialist_ids);
        return redirect('/admin/manageDoctors')->with('status','تم تعديل البيانات بشكل ناجح');
    }
    ...
    public function activateDoctor($id)
    {
        ...
        return redirect('/admin/manageDoctors')->with('status','تم تفعيل الطبيب');
    }
    public function notActivateDoctor($id)
    {
        ...
        return redirect('/admin/manageDoctors')->with('status','تم إالغاء تفعيل الدكتور');
    }
