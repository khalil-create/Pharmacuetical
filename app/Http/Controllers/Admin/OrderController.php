...
class OrderController extends Controller
{
    ...
    public function addOrder()
    {
        ...
        $items = Item::all();
        return view('admin.addOrder',compact('customers'))->with('items',$items);
    }
    public function storeOrder(Request $request)
    {
        ...
        return redirect('/admin/manageOrders')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function editOrder($id)
    {
        ...
        $items = Item::all();
        return view('admin.editOrder', compact('items'))->with('order',$order);
        }
    public function updateOrder(Request $request,$id)
    {
        ...
        return redirect('/admin/manageOrders')->with('status','تم تعديل البيانات بشكل ناجح');
    }
    public function deleteOrder($id)
    {
        ...
        // return redirect('/admin/manageOrders')->with('status','تم حذف البيانات بشكل ناجح');
    }
    public function showOrderDetails($id)
    {
        ...
        if($order->count() < 1)
            return redirect()->back()->with(['error' => 'هذه البيانات غير موجوده ']);
        return view('admin.showOrderDetails',compact('order'));
    }
}
