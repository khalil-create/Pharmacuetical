...
class CustomerController extends Controller
{
    ...
    public function addCustomer()
    {
        ...
        return view('admin.addCustomer',compact('SalesReps'))->with('SienceReps',$SienceReps);
    }
    public function storeCustomer(Request $request)
    {
        ...
        return redirect('/admin/manageCustomers')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function editCustomer($id)
    {
        ...
        if($SienceReps->count() < 1 && $SalesReps->count() < 1)
            return redirect()->back()->with(['error' => 'لايمكنك اضافة عميل ولم يتم اضافة على الاقل مندوب واحد']);
        return view('admin.editCustomer', compact('SalesReps'))
    ...
    public function updateCustomer(Request $request,$id)
    {
        ...
        return redirect('/admin/manageCustomers')->with('status','تم تعديل البيانات بشكل ناجح');
    }
    public function deleteCustomer($id)
    {
        ...
        // return redirect('/admin/manageCustomers')->with('status','تم حذف البيانات بشكل ناجح');
    }
    public function activateCustomer($id)
    {
        ...
        return redirect('/admin/manageCustomers')->with('status','تم تفعيل العميل');
    }
    public function notActivateCustomer($id)
    {
        ...
        return redirect('/admin/manageCustomers')->with('status','تم إالغاء تفعيل العميل');
    }
    public function showCustomerDetails($id)
    {
        ...
        if($customer->count() < 1)
            return redirect()->back()->with(['error' => 'هذه البيانات غير موجوده ']);
        return view('admin.showCustomerDetails',compact('customer'));
    }
}
