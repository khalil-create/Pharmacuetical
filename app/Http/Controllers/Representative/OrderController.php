...
class OrderController extends Controller
{
    ...
    public function storeOrder(Request $request)
    {
        ...
        return redirect('/representative/manageOrders')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function updateOrder(Request $request,$id)
    {
        ...
        return redirect('/representative/manageOrders')->with('status','تم تعديل البيانات بشكل ناجح');
    }
    public function deleteOrder($id)
    {
        ...
        return redirect('/representative/manageOrders')->with('status','تم حذف البيانات بشكل ناجح');
    }
}
