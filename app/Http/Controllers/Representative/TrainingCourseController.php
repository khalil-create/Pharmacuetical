...
class TrainingCourseController extends Controller
{
    ...
    public function storeCourse(Request $request)
    {
        ...
        return redirect('/representative/manageTrainingCourses')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function updateCourse(Request $request,$id)
    {
        ...
        return redirect('/representative/manageTrainingCourses')->with('status','تم تعديل البيانات بشكل ناجح');
    }
    public function deleteCourse($id)
    {
        ...
        $this->deleteFile($course->important_points,'reports/courses/');
        $course->delete();
        return redirect('/representative/manageTrainingCourses')->with('status','تم حذف البيانات بشكل ناجح');
    }
}
