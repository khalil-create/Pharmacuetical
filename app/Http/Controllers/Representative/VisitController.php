...
class VisitController extends Controller
{
    ...
    public function storeVisit(Request $request)
    {
        ...
        return redirect('/representative/manageVisits')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function updateVisit(Request $request,$id)
    {
        ...
        return redirect('/representative/manageVisits')->with('status','تم تعديل البيانات بشكل ناجح');
    }
    public function deleteVisit($id)
    {
        ...
        return redirect('/representative/manageVisits')->with('status','تم حذف البيانات بشكل ناجح');
    }
}
