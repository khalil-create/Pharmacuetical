...
class CustomerController extends Controller
{
    ...
    public function getAllCustomers(Request $request)
    {
        ...
        return view('supervisors.manageCustomers',compact('customers'));
    }
    public function addCustomer()
    {
        ...
        return view('supervisors.addCustomer')->with('reps',$reps);
    }
    public function storeCustomer(Request $request)
    {
        ...
        return redirect('/supervisor/manageCustomers')->with('status','تم إضافة البيانات بشكل ناجح');
    }
    ...
    public function editCustomer($id)
    {
        ...
        if($reps->count() < 1)
            return redirect()->back()->with(['error' => 'لايمكنك اضافة عميل ولم يتم اضافة على الاقل مندوب واحد']);
        return view('supervisors.editCustomer', compact('customer'))->with('reps',$reps);
    }
    public function updateCustomer(Request $request,$id)
    {
        ...
        return redirect('/supervisor/manageCustomers')->with('status','تم تعديل البيانات بشكل ناجح');
    }
    public function deleteCustomer($id)
    {
        ...
        // return redirect('/supervisor/manageCustomers')->with('status','تم حذف البيانات بشكل ناجح');
    }
    public function activateCustomer($id)
    {
        ...
        return redirect('/supervisor/manageCustomers')->with('status','تم تفعيل العميل');
    }
