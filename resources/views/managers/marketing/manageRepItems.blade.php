      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/managerMarketing/manageRepItems">ادارة اصناف المندوبين</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($reps as $row)
                    <tr class="odd">
                      ...
                      <td>
                        <a href="/managerMarketing/editRepItems/{{$row->id}}"><i class="nav-icon fas fa-plus" title="اضافة اصناف"></i></a>
                      </td>
                    </tr>
                  @endforeach
                  </tbody>
