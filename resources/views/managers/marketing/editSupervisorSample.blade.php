            ...
            <div class="card card-default" style="margin-left: 20px;">
                <div class="card-header">
                    <h3 class="card-title" style="float: right">
                        تعديل عينة المشرف <b>{{$supervisor->user->user_name_third}} {{$supervisor->user->user_surname}}</b>
                    </h3>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            <form method="POST" action="/managerMarketing/updateSupervisorSample/{{$sample->id}}">
                            {{ csrf_field() }}
                            {{method_field('PUT')}}
                            <div class="card-body">
                                <div class="form-group">
