                                ...
                                <div class="info-box mb-3">
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            <a href="/managerMarketing/showCategoryDetails/{{$item->category_id}}" title="تفاصيل">
                                ...
                                <div class="info-box mb-3">
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            ...
                                            <a href="/managerMarketing/showCompanyDetails/{{$comp->id}}" title="تفاصيل">
                                                - {{$comp->name_company}}
                                            </a>
                                            @endforeach
                                        </span>
...
<<<<<<< HEAD
                                        {{-- <a href="/managerMarketing/showUseDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-3"  style="height: 70px;margin:10px"> --}}
