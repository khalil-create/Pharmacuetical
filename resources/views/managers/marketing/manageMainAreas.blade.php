                  ...
                  @foreach ($mainareas as $row)
                    <tr class="odd">
                      ...
                      <td>
                        ...
                        <a href="/managerMarketing/showMainareaDetails/{{$row->id}}"><i class="fas fa-eye" title="تفاصسل"></i></a>
                      </td>
                    </tr>
                  @endforeach
                  <div>
                    <a href="{{url('/managerMarketing/addMainArea')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة منطقة رئيسية</a>
                  </div>
                  </tbody>
                  <tfoot>
                    {{-- @if($mainareas->count() > 0) --}}
        ...
        $('.DeleteBtn').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/managerMarketing/deleteMainArea/'+id,
                        data: data,
                        // dataType: "data"
