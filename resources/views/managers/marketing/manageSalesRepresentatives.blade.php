                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($rep as $row)
                    <tr class="odd">
                      ...
                      <td class="" style="">
                        <a href="/managerMarketing/editSalesRepresentative/{{$row->id}}"><i class="nav-icon fas fa-edit" title="تعديل"></i></a>
                        <a href="/managerMarketing/showSalesRepSubareas/{{$row->id}}" title="مناطق المندوب"><i class="fas fa-tasks"></i></a>
                        <a href="/managerMarketing/showSalesRepDetails/{{$row->id}}" title="تفاصيل"><i class="fas fa-eye"></i></a>
                  ...
                  @endforeach
                  <div>
                    <a href="{{url('/managerMarketing/addSalesRepresentative')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة مندوب</a>
                  </div>
                  </tbody>
                  <tfoot>
                      <tr>
        ...
        $('.DeleteBtn').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/managerMarketing/deleteSalesRepresentative/'+id,
                        data: data,
                        // dataType: "data"
