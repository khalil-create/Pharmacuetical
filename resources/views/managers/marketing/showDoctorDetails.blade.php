                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            <div class="info-box mb-3">
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">
                                        @if ($doctor->statues)
                                            <a href="/managerMarketing/notActivateDoctor/{{$doctor->id}}" title="إلغاء التفعيل"><span class="info-box-number text-success">{{'مفعل'}}</span></a>
                                        @else
                                            <a href="/managerMarketing/activateDoctor/{{$doctor->id}}" title="تفعيل"><span class="info-box-number text-danger">{{'غير مفعل'}}</span></a>
                                        @endif
                                    </span>
                                </div><!-- /.info-box-content -->
                            </div><!-- /.info-box -->
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">
                                        <a href="/managerMarketing/showRepDetails/{{$doctor->representative_id}}" title="تفاصيل">
                            ...
                            <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"><!-- Customers -->
                                @if($doctor->services->count() > 0)
                                    @foreach ($doctor->services as $row)
                                        <a href="/managerMarketing/showServiceDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-3"  style="height: 70px;margin:10px">
                                ...
                                @if($doctor->specialists->count() > 0)
                                    <div class="row">
                                        @foreach ($doctor->specialists as $row)
                                            <a href="/managerMarketing/showSpecialistDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-3"  style="height: 70px;margin:10px">
                                                <div class="col-md-12 align-right" style="margin:15px -8px 15px">
                                                    <h6>{{$row->name}}</h6>
                                                </div>
                                            </a>
