                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <form method="POST" action="/managerMarketing/UpdateMainArea/{{$area->id}}"  enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{method_field('PUT')}}
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="supervisor_id" id="supervisor_id" class="form-control custom-select rounded-0">
                                                @foreach ($supervisors as $sup)
                                                    <option value="{{ $sup->id }}" {{ old('supervisor_id',$area->supervisor_id) == $sup->id ? 'selected':'' }}>
