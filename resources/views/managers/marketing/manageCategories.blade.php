...
<<<<<<< HEAD
            <li class="breadcrumb-item"><a href="/managerMarketing/manageCategory">ادارة الاصناف</a></li>
=======
            <li class="breadcrumb-item"><a href="/managerMarketing/manageCategory">ادارة مجموعة الاصناف</a></li>
              ...
              <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                ...
                @foreach ($cat as $row)
                  ...
                  <tr class="odd">
                    ...
                    <td>
                      <a href="/managerMarketing/categoryEdit/{{$row->id}}"><i class="nav-icon fas fa-edit" title="تعديل"></i></a>
                      <input type="hidden" class="id" value="{{$row->id}}">
                      <a type="button"><i class="fas fa-trash DeleteBtn"></i></a>
                      <a href="/managerMarketing/showCategoryDetails/{{$row->id}}"><i class="nav-icon fas fa-eye" title="تفاصيل"></i></a>                      </td>
                  </tr>
                  @endforeach
                @endforeach
                <div>
        ...
        $('.DeleteBtn').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/managerMarketing/categoryDelete/'+id,
                        data: data,
                        // dataType: "data"
