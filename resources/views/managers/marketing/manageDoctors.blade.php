                    ...
                    <tbody>
                      ...
                      @foreach ($doctors as $row)
                        <tr class="odd">
                          ...
                          <td>
                              @if ($row->statues)
                                <a href="/managerMarketing/notActivateDoctor/{{$row->id}}" title="إلغاء التفعيل"><b class="text-success">{{'مفعل'}}</b></a>
                              @else
                                <a href="/managerMarketing/activateDoctor/{{$row->id}}" title="تفعيل"><b class="text-danger">{{'غير مفعل'}}</b></a>
                              @endif
                          </td>
                          <td>
                            <a href="/managerMarketing/editDoctor/{{$row->id}}"><i class="nav-icon fas fa-edit" title="تعديل"></i></a>
                            <a href="/managerMarketing/showDoctorDetails/{{$row->id}}"><i class="fas fa-eye" title="تفاصيل اكثر"></i></a>
                      ...
                      @endforeach
                      <div>
                          <a href="{{url('/managerMarketing/addDoctor')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة طبيب</a>
                      </div>
                    </tbody>
                    <tfoot>
                        <tr>
        ...
        $('.DeleteBtn').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/managerMarketing/deleteDoctor/'+id,
                        data: data,
                        // dataType: "data"
