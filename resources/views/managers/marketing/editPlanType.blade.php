        ...
        <div class="container-fluid">
            ...
            <div class="card card-default" style="margin-left: 20px;">
                <div class="card-header">
                    <h3 class="card-title" style="float: right">تعديل نوع خطة</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <form method="POST" action="{{ url('managerMarketing/updatePlanType',$planType->id) }}"  enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="name_main_area">اسم نوع الخطة</label>
                                            <input value="{{$planType->plan_type_name}}" type="text" name="plan_type_name" class="form-control" id="name_main_area">
