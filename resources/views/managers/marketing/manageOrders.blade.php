                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($orders as $row)
                    <tr class="odd">
                      ...
                      <td>{{$row->note}}</td>
                      <td>
                        <a href="/managerMarketing/editOrder/{{$row->id}}"><i class="nav-icon fas fa-edit" title="تعديل"></i></a>
                        <a href="/managerMarketing/showOrderDetails/{{$row->id}}"><i class="fas fa-eye" title="تفاصيل"></i></a>
                  ...
                  @endforeach
                  <div>
                    <a href="{{url('/managerMarketing/addOrder')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة طلبية</a>
                  </div>
                  </tbody>
                  <tfoot>
                    <tr>
        ...
        $('.DeleteBtn').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/managerMarketing/deleteOrder/'+id,
                        data: data,
                        // dataType: "data"
