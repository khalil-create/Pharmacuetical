                            ...
                            <div class="info-box mb-3">
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">
                                        <a href="/managerMarketing/showSupervisorDetails/{{$mainarea->supervisor->user_id}}" title="تفاصيل">
                                            {{$mainarea->supervisor->user->user_name_third}} {{$mainarea->supervisor->user->user_surname}}
                                        </a>
                                    </span>
                                </div><!-- /.info-box-content -->
                            </div><!-- /.info-box -->
                                ...
                                <a class="nav-item nav-link active" id="product-desc-tab" data-toggle="tab" href="#product-desc" role="tab" aria-controls="product-desc" aria-selected="true">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number">
<<<<<<< HEAD
                                                {{$mainarea->representatives->count()}}
=======
                        ...
                        <div class="tab-content p-3" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"><!-- Services -->
                                <div class="col-md-6">
                                    <div class="khalil">
                                        <div class="card-header">
                                            <h3 class="card-title" style="float: right">المندوبيين العلميين ( {{$mainarea->representatives->whereNotNull('supervisor_id')->count()}} )</h3>
                                        </div>
                                        <div class="card-body">
                                            @if($mainarea->representatives->whereNotNull('supervisor_id')->count() > 0)
                                                @foreach ($mainarea->representatives->whereNotNull('supervisor_id') as $row)
                                                    <a href="/managerMarketing/showRepDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-5"  style="height: 70px;margin:10px">
<<<<<<< HEAD
...
>>>>>>> 4bc6d0e5719fbdf8d90c9dc20f8daaa499dc4193
                                ...
                                <div class="col-md-6">
                                    <div class="khalil">
                                        <div class="card-header">
                                            <h3 class="card-title" style="float: right">مندوبيين المبيعات ( {{$mainarea->representatives->whereNotNull('manager_id')->count()}} )</h3>
                                        </div>
                                        <div class="card-body">
                                            @if($mainarea->representatives->whereNotNull('manager_id')->count() > 0)
                                                @foreach ($mainarea->representatives->whereNotNull('manager_id') as $row)
                                                    <a href="/managerMarketing/showRepDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-5"  style="height: 70px;margin:5px">
<<<<<<< HEAD
                                                        <div style="margin:12px -8px 38px 5px">
=======
                                                        <div style="margin:1px -8px 38px 5px">
                                ...
                                @if($mainarea->subareas->count() > 0)
                                    <div class="row">
                                        @foreach ($mainarea->subareas as $row)
                                            <a href="/managerMarketing/showSubareaDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-3"  style="height: 70px;margin:5px">
                                                <div style="margin:12px -8px 38px 5px">
