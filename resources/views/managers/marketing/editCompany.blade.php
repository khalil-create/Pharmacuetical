                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <form method="POST" action="/managerMarketing/companyUpdate/{{$company->id}}"  enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{method_field('PUT')}}
...
<<<<<<< HEAD
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="supervisor_id" id="supervisor_id" class="form-control custom-select rounded-0">
                                                ...
                                                <option value="{{$row->id}}" {{ old('supervisor_id',$company->supervisor_id) == $row->id ? 'selected':'' }}>
