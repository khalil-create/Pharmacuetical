                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <form method="POST" action="/managerMarketing/updateUse/{{$use->id}}"  enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{method_field('PUT')}}
                                    <div class="card-body border">
                                        <div class="form-group">
                                            <label for="use">الاستخدام</label>
                                            <input type="text" value="{{ old('use',$use->use) }}" name="use" class="form-control" id="use">
                                            @if ($errors->has('use'))
