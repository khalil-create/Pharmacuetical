    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/managerMarketing/manageRepresentatives">ادارة مندوبيين المبيعات</a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="card-body">
                ...
                <div class="col-sm-12">
                    ...
                    @endforeach
                    <div>
                        <a href="{{url('/managerMarketing/addSalesRepSubareas',$rep->id)}}" class="btn btn-primary add">
