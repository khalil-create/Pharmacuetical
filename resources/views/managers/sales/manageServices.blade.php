                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($services as $row)
                    <tr class="odd">
                      ...
                      <td>
                        <a href="/managerSales/editService/{{$row->id}}"><i class="nav-icon fas fa-edit" title="تعديل"></i></a>
                  ...
                  @endforeach
                  <div>
                    <a href="{{url('/managerSales/addService')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة خدمة</a>
                  </div>
                  </tbody>
                  <tfoot>
                    @if($services->count() > 0)
        ...
        $('.DeleteBtn').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/managerSales/deleteService/'+id,
                        data: data,
                        // dataType: "data"
