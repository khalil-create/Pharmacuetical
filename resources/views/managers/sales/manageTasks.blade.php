                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($tasks as $row)
                    <tr class="odd">
                      ...
                      <td>
                        @if ($row->performed == 0)
                          <a href="/managerSales/editTask/{{$row->id}}"><i class="nav-icon fas fa-edit"></i></a>
                  ...
                  @endforeach
                  <div>
                    <a href="{{url('/managerSales/addTask')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة مهمة</a>
                  </div>
                  </tbody>
                  <tfoot>
                    @if($tasks->count() > 0)                    
        ...
        $('.DeleteBtn').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/managerSales/deleteTask/'+id,
                        data: data,
                        // dataType: "data"
