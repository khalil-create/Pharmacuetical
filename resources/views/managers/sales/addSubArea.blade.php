                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            @if(isset($mainarea))
                                <form method="POST" action="/managerSales/storeSubArea/{{$mainarea->id}}"  enctype="multipart/form-data">
                            @else
                                <form method="POST" action="{{ url('managerSales/storeSubArea/0') }}"  enctype="multipart/form-data">
                            @endif
                            {{ csrf_field() }}
                            <div class="card-body">
                                <div class="form-group">
                                ...
                                @if(!isset($mainarea))
                                    <div class="form-group">
                                        <label for="mainarea_id" class="col-md-6 control-label">المنطقة الرئيسية التابعة لها</label>
                                        ...
                                        @if ($errors->has('mainarea_id'))
                                            <span class="help-block">
                                                <strong>{{ $errors->first('mainarea_id') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                @endif
