          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                @php
                    $username = explode(' ',$user->user_name_third);
                @endphp
                <h3 class="profile-username text-center">{{$username[0]}} {{$user->user_surname}}</h3>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="radiobox">
                                          <div class="form-check">
                                              <input {{$male}} class="form-check-input" type="radio" value="ذكر" name="sex" checked>
                                              <label class="form-check-label">ذكر</label>
                                          </div>
                                          <div class="form-check">
                                          <input {{$female}} class="form-check-input" type="radio" name="sex" value="انثى">
