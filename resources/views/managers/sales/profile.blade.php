        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="/managerSales/profile/{{Auth::user()->id}}">البروفايل الشخصي</a></li>
                  ...
                  <div class="card-footer">
                    <ul class="list-group list-group-unbordered mb-3">
                      <li class="list-group-item">
                        <b>مندوبيين المبيعات</b> <a class="float-right">{{App\Models\Representative::whereNotNull('manager_id')->get()->count()}}</a>
                      </li>
                      <li class="list-group-item">
                        @php $countCust = 0; foreach(Auth::user()->manager->representatives as $rep){ $countCust +=$rep->customers->where('statues',true)->count();} @endphp
                        <b>العملاء</b> <a class="float-right">{{$countCust}}</a>
                      </li>
                      <li class="list-group-item">
                          <b>الطلبيات</b> <a class="float-right">{{App\Models\Order::all()->count()}}</a>
                      </li>
                    </ul>
                      ...
                      <div class="tab-pane" id="settings">
                        <div class="row">
                            <div class="form-group">
                              <form action="/managerSales/profileUpdate/{{$user->id}}" class="form" method="POST" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{method_field('PUT')}}
                                  <div class="col-md-6">
                                      <div class="khalil">
