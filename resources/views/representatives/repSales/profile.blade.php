        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="/repSales/profile/{{Auth::user()->id}}">البروفايل الشخصي</a></li>
                  ...
                  <div class="card-footer">
                    <ul class="list-group list-group-unbordered mb-3">
                      <li class="list-group-item">
                        <b>العملاء</b> <a class="float-right">{{Auth::user()->representatives->customers->count()}}</a>
                      </li>
                      <li class="list-group-item">
                      ...
                      <div class="tab-pane" id="settings">
                        <div class="row">
                            <div class="form-group">
                              <form action="/repSales/profileUpdate/{{$user->id}}" class="form" method="POST" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{method_field('PUT')}}
                                  <div class="col-md-6">
                                      <div class="khalil">
