                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <form id="form" method="POST" action="/repSales/updateOrder/{{$order->id}}"  enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    <div class="card-body border">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label>الكمية</label>
                                            <input type="text" value="{{$order->count}}" name="count" class="form-control">
                                            @if ($errors->has('count'))
