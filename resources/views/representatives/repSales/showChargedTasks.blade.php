      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            <span class="card-title" style="float: right"> قائمة المهام المكلفة</span>
                  ...
                  <tbody>
                    ...
                    @foreach ($tasks as $row)
                      <tr class="odd">
                        ...
                        <td>
                          @if ($row->performed == 0)
                              <a href="/repSales/performTask/{{$row->id}}"><i class="fas fa-play" title="تنفيذ المهمة"></i></a>
                          @else
                                  @php
                              ...
                              @endif
                              <a href="/repSales/performTask/{{$row->id}}"><i class="fas fa-edit" title="تعديل تنفيذ المهمة"></i></a>
                          @endif
                        </td>
                      </tr>
                    @endforeach
