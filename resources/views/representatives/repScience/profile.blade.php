        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="/repSience/profile/{{Auth::user()->id}}">البروفايل الشخصي</a></li>
                  ...
                  <div class="card-footer">
                    <ul class="list-group list-group-unbordered mb-3">
                      <li class="list-group-item">
                        <b>العملاء</b> <a class="float-right">{{Auth::user()->representatives->customers->where('statues',true)->count()}}</a>
                      </li>
                      <li class="list-group-item">
                          <b>الاطباء</b> <a class="float-right">{{Auth::user()->representatives->doctors->where('statues',true)->count()}}</a>
                      </li>
                      <li class="list-group-item">
                        <b>الاصناف</b> <a class="float-right">{{Auth::user()->representatives->items->count()}}</a>
                      </li>
                      <li class="list-group-item">
                          <b>الطلبيات</b> <a class="float-right">{{Auth::user()->representatives->orders->count()}}</a>
                      </li>
                    </ul>
                      ...
                      <div class="tab-pane" id="settings">
                        <div class="row">
                            <div class="form-group">
                              <form action="/repSience/profileUpdate/{{$user->id}}" class="form" method="POST" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{method_field('PUT')}}
                                  <div class="col-md-6">
                                      <div class="khalil">
