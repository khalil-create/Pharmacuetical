      ...
      <div class="card card-default">
        ...
        <div class="card-body">
          <div class="form-group">
            <form method="POST" action="/repScience/storePlanCustomer/{{$plan->id}}" onsubmit="return checkDataPlan()" enctype="multipart/form-data">
              {{ csrf_field() }}
              <div class="card-body">
                <div class="khalil">
                  <div class="card-header">
              ...
              <tbody>
                ...
                @foreach ($plan->customers_all as $row)
                  <tr class="odd">
                    ...
                    <td>
                      <a href="/repScience/editPlanCustomer/{{$row->id}}"><i class="nav-icon fas fa-edit" title="تعديل"></i></a>
