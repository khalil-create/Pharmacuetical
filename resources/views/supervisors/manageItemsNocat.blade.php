                  ...
                  @foreach ($companies as $comp)
                      @foreach ($comp->items as $row)
                        ...
                        <tr class="odd">
                          ...
                          <td>
                            <a href="/supervisor/itemEditNoCat/{{$row->id}}"><i class="nav-icon fas fa-edit kkk" title="تعديل"></i></a>
                            <a href="/supervisor/itemUsesNoCat/{{$row->id}}"><i class="fas fa-info" title="الاستخدامات"></i></a>
