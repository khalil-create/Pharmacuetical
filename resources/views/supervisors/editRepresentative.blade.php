...
<div class="content-header content-wrapper">
    ...
    <section class="content" >
            ...
            <div class="card card-default" style="margin-left: 20px;">
                ...
                <h3 class="card-title" style="float: right">تعديل المندوب العلمي</h3>
                            ...
                            <form method="POST" action="/supervisor/updateRepresentative/{{$rep->user->id}}"  enctype="multipart/form-data">
                                ...
                                <div class="card-body border">
                                    <div class="col-md-6">
                                        ...
                                        @if($teamLeader)
                                            <div class="form-group" id="teemLeadersList" {{old('usertype',$rep->user->user_type) != 'مندوب علمي' ? 'hidden':''}}>
