        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-left">
              <li class="breadcrumb-item"><a href="/supervisor/profile/{{Auth::user()->id}}">البروفايل الشخصي</a></li>
                  ...
                  <div class="card-footer">
                    <ul class="list-group list-group-unbordered mb-3">
                      <li class="list-group-item">
                        <b>المندوبيين العلميين</b> <a class="float-right">{{Auth::user()->supervisor->representatives->whereNotNull('supervisor_id')->count()}}</a>
                      </li>
                      <li class="list-group-item">
                        @php $countCust = 0; foreach(Auth::user()->supervisor->representatives as $rep){ if($rep->customers) $countCust +=$rep->customers->where('statues',true)->count();} @endphp
                        <b>العملاء</b> <a class="float-right">{{$countCust}}</a>
                      </li>
                      <li class="list-group-item">
                          <b>الاطباء</b> <a class="float-right">{{Auth::user()->supervisor->doctors->where('statues',true)->count()}}</a>
                      </li>
                      <li class="list-group-item">
                          <b>الشركات</b> <a class="float-right">{{Auth::user()->supervisor->companies->count()}}</a>
                      </li>
                    </ul>
                      ...
                      <div class="tab-pane" id="settings">
                        <div class="row">
                            <div class="form-group">
                              <form action="/supervisor/profileUpdate/{{$user->id}}" class="form" method="POST" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                  {{method_field('PUT')}}
                                  <div class="col-md-6">
                                      <div class="khalil">
