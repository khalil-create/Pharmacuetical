            ...
            <div class="row">
              <div class="col-sm-12">
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  <tbody>
                  <?php $i=1?>
                  @foreach ($supervisor->orders as $row)
                    <tr class="odd">
                  ...
                  @endforeach
                  <div>
                    <a href="{{url('/supervisor/addOrder')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة طلبية</a>
                  </div>
                  </tbody>
                  <tfoot>
                    <tr>
