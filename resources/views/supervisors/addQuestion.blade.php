        ...
        <div class="container-fluid">
            ...
            <div class="card card-default" style="margin-left: 20px;">
                <div class="card-header">
                    <h3 class="card-title" style="float: right">إضافة سؤال</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            <form method="POST" action="/supervisor/storeQuestion/{{$test->id}}"  enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="card-body">
                                <div class="form-group">
                                    <label>السؤال</label>
                                ...
                                @if($type == 1)
                                    <div class="form-group">
                                        <div class="khalil col-md-12">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <input type="text" id="choice1" name="choice1" class="form-control" placeholder="الاختيار الاول">
                                                    ...
                                                    <div class="col-12">
                                                        <input type="text" id="choice2" name="choice2" class="form-control" placeholder="الاختيار الثاني">
                                                    ...
                                                    <div class="col-12">
                                                        <input type="text" id="choice3" name="choice3" class="form-control" placeholder="الاختيار الثالث">
                                                    ...
                                                    <div class="col-12">
                                                        <input type="text" id="choice4" name="choice4" class="form-control" placeholder="الاختيار الرابع">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input onkeyup="checkAnswer()" type="text" id="right_answer" name="right_answer" class="form-control">
                                                ...
                                                <div class="row radiobox">
                                                    <div class="col-6">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio" name="right_answer" value="صواب" checked>
                                                                <label class="form-check-label">صواب</label>
                                                            </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="right_answer" value="خطأ">
