                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($rep as $row)
                    <tr class="odd">
                      ...
                      <td class="" style="">
                        <a href="/editRepresentative/{{$row->id}}"><i class="nav-icon fas fa-edit"></i></a>
                        <a href="/showMainareas/{{$row->id}}" ><i class="fas fa-tasks"></i></a>
                        <i class="fas fa-eye"></i>
                      </td>
                    </tr>
                  @endforeach
                  <div>
                    <a href="{{url('/addRepresentative')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة مندوب</a>
                    @if (session('status'))
                      <div class="alert alert-success notify-success">
                          {{ session('status') }}
                      </div>
