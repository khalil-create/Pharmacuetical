      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            <span class="card-title" style="float: right">قائمة الأسئلة</span>
                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($questions as $row)
                    <tr class="odd">
                      ...
                      <td>
                        <a href="/supervisor/editQuestion/{{$row->id}}"><i class="nav-icon fas fa-edit kkk" title="تعديل"></i></a>
                        <form action="/supervisor/deleteQuestion/{{$row->id}}" method="post" style="float: right;">
                            {{csrf_field()}}
                            {{method_field('DELETE')}}
