      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">نقاط القوة الترويجية</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($study->strengths as $row)               
                    <tr class="odd">
                      ...
                      <td>{{$row->strength}}</td>
                      <td>
                        <a href="/supervisor/editStrength/{{$row->id}}"><i class="nav-icon fas fa-edit"></i></a>
                        {{-- <form action="/supervisor/deleteStrength/{{$row->id}}" method="post" style="float: right;">
                            {{csrf_field()}}
                            {{method_field('DELETE')}}
        ...
        $('.DeleteBtn').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/supervisor/deleteStrength/'+id,
                        data: data,
                        // dataType: "data"
