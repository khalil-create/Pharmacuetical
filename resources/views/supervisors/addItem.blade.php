                        ...
                        <div class="form-group">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="unit" class="col-md-12 control-label">وحدة البيع</label>
                                    ...
                                    <div class="form-group col-md-6" id="category" hidden>
                                    ...
                                    <div class="form-group col-md-6" id="company" hidden>
