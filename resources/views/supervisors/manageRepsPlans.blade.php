            ...
            <div class="row">
              <div class="col-sm-12">
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($plans as $row)
                    <tr class="odd">
                      ...
                      <td>
                        ...
                        <a href="/supervisor/planDetials/{{$row->id}}"><i title="عرض الخطط" class="fas fa-eye"></i></a>
                  ...
                  @endforeach
                  <div>
                    <a href="{{url('/supervisor/addRepPlan')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة خطة</a>
                  </div>
                  </tbody>
                  <tfoot>
                    @if($plans->count() > 0)
        ...
        $('.DeleteBtn').click(function(e){
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: '/supervisor/deleteRepPlan/'+id,
                        data: data,
                        // dataType: "data"
