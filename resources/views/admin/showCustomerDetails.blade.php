            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/admin/manageCustomers">ادارة العملاء</a></li>
                        ...
                        <div class="col-12 col-sm-6 col-md-3">
                            <div class="info-box mb-3">
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">
                                        @if ($customer->statues)
                                            <a href="/admin/notActivateCustomer/{{$customer->id}}" title="إلغاء التفعيل"><span class="info-box-number text-success">{{'مفعل'}}</span></a>
                                        @else
                                            <a href="/admin/activateCustomer/{{$customer->id}}" title="تفعيل"><span class="info-box-number text-danger">{{'غير مفعل'}}</span></a>
                                        @endif
                                    </span>
                                </div><!-- /.info-box-content -->
                            </div><!-- /.info-box -->
                                    ...
                                    <span class="info-box-number">
                                        @foreach ($customer->representative as $rep)
                                            @if ($rep->user->user_type == 'مندوب علمي' || $rep->user->user_type == 'مدير فريق')
                                                <a href="/admin/showUserDetails/{{$rep->user_id}}" title="تفاصيل">
                            ...
                            <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"><!-- Services -->
                                @if($customer->services->count() > 0)
                                    @foreach ($customer->services as $row)
                                        {{-- <a href="/admin/showServiceDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-4"  style="height: 70px;margin:10px"> --}}
                                        <a class="btn btn-block btn-default btn-lg col-md-4"  style="height: 70px;margin:10px">
                                ...
                                @if($customer->orders->count() > 0)
                                    <div class="row">
                                        @foreach ($customer->orders as $row)
                                            <a href="/admin/showOrderDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-3"  style="height: 70px;margin:10px">
                                                <div class="col-md-12" style="margin:15px -8px 15px">
