                                ...
                                <div class="info-box mb-3">
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            <a href="/admin/showCategoryDetails/{{$item->category_id}}" title="تفاصيل">
                                ...
                                <div class="info-box mb-3">
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number">
                                            ...
                                            <a href="/admin/showCompanyDetails/{{$comp->id}}" title="تفاصيل">
                                                - {{$comp->name_company}}
                                            </a>
                                            @endforeach
                                        </span>
                            ...
                            <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"><!-- uses -->
                                @if($item->uses->count() > 0)
                                    @foreach ($item->uses as $row)
                                        {{-- <a href="/admin/showUseDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-3"  style="height: 70px;margin:10px"> --}}
