              ...
              <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                ...
                @foreach ($cat as $row)
                  ...
                  <tr class="odd">
                    ...
                    <td>
                      <a href="/admin/categoryEdit/{{$row->id}}"><i class="nav-icon fas fa-edit" title="تعديل"></i></a>
                      <input type="hidden" class="id" value="{{$row->id}}">
                      <a type="button"><i class="fas fa-trash DeleteBtn"></i></a>
                      <a href="/admin/showCategoryDetails/{{$row->id}}"><i class="nav-icon fas fa-eye" title="تفاصيل"></i></a>                      </td>
                  </tr>
                  @endforeach
                @endforeach
                <div>
                  <a href="{{url('/admin/categoryAdd')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة مجموعة اصناف</a>
                </div>
                </tbody>
                <tfoot>
                  <tr>
