      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title" style="float: right">قائمة التخصصات</h3>
                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($specialists as $row)
                    <tr class="odd">
                      ...
                      <td>{{$row->name}}</td>
                      <td>
                        <a href="/admin/editSpecialist/{{$row->id}}"><i class="nav-icon fas fa-edit"></i></a>
                  ...
                  @endforeach
                  <div>
                    <a href="{{url('/admin/addSpecialist')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة تخصص جديد</a>
                  </div>
                  </tbody>
                  <tfoot>
                    @if($specialists->count() > 0)
                      <tr>
                        ...
                        <th rowspan="1" colspan="1">التخصص</th>
