  ...
  <div class="content">
    <div class="container-fluid">
      <div class="card card-default">
        ...
        <div class="card-body">
          <div>
            <a href="{{url('/admin/itemAdd')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة صنف</a>
          </div>
          <div class="row">
                    ...
                    @if($comp->items->count() > 0)
                      @foreach ($comp->items as $row)
                        <tr class="odd">
                          ...
                          <td>
                            <a href="/admin/itemEdit/{{$row->id}}"><i class="nav-icon fas fa-edit kkk" title="تعديل"></i></a>
                            <a href="/admin/itemUses/{{$row->id}}"><i class="fas fa-info" title="الاستخدامات"></i></a>
                              <input type="hidden" class="id" value="{{$row->id}}">
                            <a type="button"><i class="fas fa-trash DeleteBtn"></i></a>
                            <a href="/admin/showItemDetails/{{$row->id}}"><i class="fas fa-eye" title="التفاصيل"></i></a>
                          </td>
                        </tr>
                      @endforeach
                    @else
