                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <form method="POST" action="/admin/updateCustomer/{{$customer->id}}"  enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                            ...
                                            <div class="khalil">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <input value="{{$customer->owner_phone}}" id="phonenumber"  onkeyup="checkPhoneNumber()" type="text" name="owner_phone" class="form-control" placeholder="رقم هاتف المالك">
