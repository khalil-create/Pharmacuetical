                            ...
                            <div class="info-box mb-3">
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">
                                        <a href="/admin/showUserDetails/{{$company->supervisor->user_id}}" title="تفاصيل">
                            ...
                            <div class="tab-pane fade show active" id="product-desc" role="tabpanel" aria-labelledby="product-desc-tab"><!-- categories -->
                                @if($company->categories->count() > 0)
                                    @foreach ($company->categories as $row)
                                        <a href="/admin/showCategoryDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-2"  style="height: 70px;margin:10px">
                                    ...
                                    @if($company->have_category)
                                        @foreach ($company->categories as $cat)
                                            ...
                                            @foreach ($cat->items as $item)
                                                <a href="/admin/showItemDetails/{{$row->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-2"  style="height: 70px;margin:10px">
                                                    <div class="col-md-12" style="margin:15px -8px 15px">
                                    ...
                                    @else
                                        @if($company->items->count() > 0)
                                            @foreach ($company->items as $item)
                                                <a href="/admin/showItemDetails/{{$item->id}}" title="تفاصيل" class="btn btn-block btn-default btn-lg col-md-3"  style="height: 70px;margin:10px">
                                                    <div class="col-md-12" style="margin:15px -8px 15px">
                                                        <h6>{{$item->commercial_name}}</h6>
                                                    </div>
                                                </a>
