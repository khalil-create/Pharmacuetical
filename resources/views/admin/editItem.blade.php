                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <form method="POST" action="/admin/itemUpdate/{{$item->id}}"  enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    {{method_field('PUT')}}
                                    <div class="card-body border">
                                        <div class="form-group col-md-6">
                                            <label for="commercial_name">الاسم التجاري</label>
                                            <input type="text" value="{{ old('commercial_name',$item->commercial_name) }}" name="commercial_name" class="form-control" id="commercial_name">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" value="{{ old('science_name',$item->science_name) }}" name="science_name" class="form-control" id="science_name">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="unit" class="control-label">الوحده</label>
                                            <select name="unit" id="unit" class="form-control custom-select rounded-0">
                                                <option value="باكت" {{ old('unit',$item->unit) == 'باكت' ? 'selected':'' }}>
                                                    باكت
                                                </option>
                                                <option value="شريط" {{ old('unit',$item->unit) == 'باكت' ? 'selected':'' }}>
                                                شريط
                                                </option>
                                                <option value="قارورة" {{ old('unit',$item->unit) == 'قارورة' ? 'selected':'' }}>
                                                قارورة
                                                </option>
                                            </select>
                                            @if ($errors->has('unit'))
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" value="{{ old('price',$item->price) }}" name="price" class="form-control" id="price">
                                            @if ($errors->has('price'))
                                                <span class="help-block">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" value="{{ old('bonus',$item->bonus) }}" name="bonus" class="form-control" id="bonus">
                                            @if ($errors->has('bonus'))
                                                <span class="help-block">
                                        ...
                                        <div class="form-group col-md-6" id="category" @php if(!$have_cat) echo 'hidden'; @endphp>
                                        ...
                                        <div class="form-group col-md-6" id="company" @php if($have_cat) echo 'hidden'; @endphp>
