                ...
                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                  ...
                  @foreach ($customers as $row)
                    <tr class="odd">
                      ...
                      <td>
                        @if ($row->statues)
                          <a href="/admin/notActivateCustomer/{{$row->id}}" title="إلغاء التفعيل">
                            <b class="text-success">{{'مفعل'}}</b>
                          </a>
                        @else
                          <a href="/admin/activateCustomer/{{$row->id}}" title="تفعيل">
                            <b class="text-danger">{{'غير مفعل'}}</b>
                          </a>
                        @endif
                      </td>
                      <td>
                        <a href="/admin/editCustomer/{{$row->id}}"><i class="nav-icon fas fa-edit" title="تعديل"></i></a>
                        <a href="/admin/showCustomerDetails/{{$row->id}}"><i class="fas fa-eye" title="تفاصيل"></i></a>
                  ...
                  @endforeach
                  <div>
                    <a href="{{url('/admin/addCustomer')}}" class="btn btn-primary add"><i class="fas fa-plus"></i> اضافة عميل</a>
                  </div>
                  </tbody>
                  <tfoot>
                      <tr>
